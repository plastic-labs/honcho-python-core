...
from ....types.workspaces.sessions import observation_list_params, observation_query_params
from ....types.workspaces.sessions.observation import Observation
from ....types.workspaces.sessions.observation_query_response import ObservationQueryResponse
...
class ObservationsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            f"/v2/workspaces/{workspace_id}/sessions/{session_id}/observations/list",
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            f"/v2/workspaces/{workspace_id}/sessions/{session_id}/observations/{observation_id}",
            options=make_request_options(
    ...
    def query(
        ...
        *,
        ...
        if not session_id:
            raise ValueError(f"Expected a non-empty value for `session_id` but received {session_id!r}")
        return self._post(
            f"/v2/workspaces/{workspace_id}/sessions/{session_id}/observations/query",
