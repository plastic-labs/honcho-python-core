...
- <code title="post /v2/workspaces/{workspace_id}/peers/{peer_id}/representation">client.workspaces.peers.<a href="./src/honcho_core/resources/workspaces/peers/peers.py">get_representation</a>(peer_id, \*, workspace_id, \*\*<a href="src/honcho_core/types/workspaces/peer_get_representation_params.py">params</a>) -> <a href="./src/honcho_core/types/workspaces/peer_get_representation_response.py">PeerGetRepresentationResponse</a></code>
...
- <code title="get /v2/workspaces/{workspace_id}/queue/status">client.workspaces.queue.<a href="./src/honcho_core/resources/workspaces/queue.py">get_status</a>(workspace_id, \*\*<a href="src/honcho_core/types/workspaces/queue_get_status_params.py">params</a>) -> <a href="./src/honcho_core/types/workspaces/queue_get_status_response.py">QueueGetStatusResponse</a></code>
