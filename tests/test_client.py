...
class TestHoncho:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Honcho) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Honcho) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncHoncho:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncHoncho) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
